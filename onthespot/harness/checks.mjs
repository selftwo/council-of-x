...
// Carried unchanged from rehearsal-lab/harness/checks.mjs.
//   node checks.mjs ../runs/<run-id>     (also imported by report.mjs)
...
export function runChecks(runDir) {
  ...
  // overlong reply: prompt says under 90-100 words; tolerance 110. Debrief (last turn) allowed 260.
