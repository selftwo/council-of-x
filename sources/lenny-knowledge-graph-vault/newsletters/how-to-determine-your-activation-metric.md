...
topics: ["onboarding", "b2b-saas", "growth", "retention", "metrics"]
frameworks: []
companies: ["Airtable", "Amazon", "Amplitude", "Asana", "Figma", "Hotjar", "Linear", "LinkedIn", "Mixpanel", "Segment", "Slack", "Snyk", "Tesla", "YouTube"]
people: ["Ben Williams", "Jackie Bavaro", "Karri Saarinen", "Lauryn Isford", "Merci Grace"]
word_count: 3813
status: "processed"
