...
topics: ["design", "ai", "product-strategy", "leadership", "engineering"]
frameworks: ["JTBD", "OKRs"]
companies: ["Allbirds", "Amazon", "Apple", "Asana", "Descript", "Duolingo", "Facebook", "Figma", "GitHub", "Glossier", "Google", "Jira", "LinkedIn", "Miro", "Notion", "OpenAI", "Salesforce", "Shopify", "Snowflake", "Substack", "Twitter"]
people: []
word_count: 4586
status: "processed"
