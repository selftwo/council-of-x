...
topics: ["founder", "b2b-saas", "design", "scaling", "product-strategy"]
frameworks: ["Product-Market Fit"]
companies: ["AWS", "Airbnb", "Airtable", "Amplitude", "Apple", "Auth0", "Canva", "Coinbase", "Databricks", "Dropbox", "Figma", "Google", "Gusto", "Jira", "Linear", "LinkedIn", "Miro", "Mixpanel", "Notion", "Palantir", "Plaid", "Retool", "Robinhood", "Segment", "Shopify", "Slack", "Snowflake", "Snyk", "Stripe", "Substack", "Twitter", "Uber", "YouTube"]
people: []
word_count: 9118
status: "processed"
