...
topics: ["founder", "design", "growth", "consumer", "product-strategy"]
frameworks: ["Flywheel", "Growth Loops", "Network Effects", "North Star Metric", "Product-Market Fit"]
companies: ["Airbnb", "Amazon", "Apple", "DoorDash", "Etsy", "Facebook", "Google", "Grubhub", "Instagram", "Lyft", "Notion", "Pinterest", "Postmates", "Reddit", "Rippling", "Roblox", "Segment", "Snapchat", "Spotify", "Substack", "Tesla", "TikTok", "Twitter", "Uber", "WhatsApp", "YouTube", "eBay"]
people: ["Sarah Tavel"]
word_count: 19069
status: "processed"
