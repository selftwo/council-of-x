...
topics: ["growth", "design", "founder", "analytics", "product-strategy"]
frameworks: []
companies: ["AWS", "Airbnb", "Amplitude", "Apple", "Calendly", "Discord", "Dropbox", "Etsy", "Facebook", "Google", "Instagram", "LinkedIn", "Meta", "Nike", "Outreach", "PayPal", "Reddit", "Segment", "Slack", "Spotify", "Substack", "Superhuman", "Telegram", "Tesla", "TikTok", "Twilio", "Twitch", "Twitter", "Uber", "Venmo", "Webflow", "WhatsApp", "YouTube", "eBay"]
people: ["John Cutler", "Julian Shapiro"]
word_count: 11679
status: "processed"
